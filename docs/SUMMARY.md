...
- [Module Enablement](module-enablement/index.md)
  ...
  - [Overrides](module-enablement/overrides.md)
- [Options](options/index.md)
  - [NixOS Options](options/nixos/index.md)

    {{NIXOS_OPTIONS}}
  - [Darwin Options](options/darwin/index.md)

    {{DARWIN_OPTIONS}}
  - [Home Manager Options](options/home-manager/index.md)
