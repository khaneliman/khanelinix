...
After editing references, run `<path-to-skill>/scripts/validate-snippets.sh`. It
checks shell fence syntax and Nix subcommands and flags. It does not build
packages, fetch remotes, or update lock files.
