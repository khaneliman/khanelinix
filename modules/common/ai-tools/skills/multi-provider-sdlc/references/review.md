...
Fable and Astra have equal preference. The resolver breaks ties in canonical
order; constrain its subscription when task context requires another provider.
