---
name: docx
description: "Create, inspect, or edit Word DOCX documents with tracked changes, comments, formatting preservation, OOXML access, and text extraction. Use for professional document workflows; use pdf for PDF-only work."
