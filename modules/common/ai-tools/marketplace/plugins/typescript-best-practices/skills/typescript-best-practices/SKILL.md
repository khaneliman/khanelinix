...
Apply `type-system-discipline` from `engineering-principles` first. This skill
grounds that principle in TypeScript syntax.
...
| Boundary validation   | Validate where data crosses in; trust types inside. Apply `boundary-discipline` from `engineering-principles`.                                                                                                 |
