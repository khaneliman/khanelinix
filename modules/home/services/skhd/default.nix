  ...
  config = mkIf cfg.enable {
    ...
    services.skhd = {
      ...
      config = /* Bash */ ''
        ...
        # Reload yabai
        default < ctrl + lalt + cmd - r : bash -c launchctl kickstart -k gui/"$(id -u)"/org.nixos.yabai
        default < shift + lalt + cmd - r : bash -c launchctl kickstart -k gui/"$(id -u)"/org.nix-community.home.skhd
