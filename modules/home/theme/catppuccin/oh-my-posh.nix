    ...
    programs.oh-my-posh.settings = {
      tooltips = [
        ...
        }
        {
          type = "aws";
          style = "plain";
          foreground = catppuccin.colors.peach.hex;
          tips = [
            "aws"
            "terraform"
            "terragrunt"
      ...
      blocks = lib.mkForce [
        ...
        }
        {
          ...
          alignment = "right";
          overflow = "hide";
          filler = "{{ if .Overflow }}<${catppuccin.colors.surface1.hex},transparent> </>{{ else }}<${catppuccin.colors.surface1.hex},transparent>.</>{{ end }}";
          segments = [
            {
              type = "node";
              style = "powerline";
