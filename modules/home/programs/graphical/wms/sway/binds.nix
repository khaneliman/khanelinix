      ...
      config = {
        keybindings =
          ...
          lib.mkOptionDefault {
            ...
            # "Control+Alt+mouse_down" = "workspace next";
            # "Control+Alt+mouse_up" = "workspace prev";

            # Moving to workspace
            "Alt+Hyper_L+right" = "move container to workspace next";
            "Alt+Hyper_L+left" = "move container to workspace prev";
        ...
        # ░█▄█░█░█░█▀▄░█▀▄░▀▀█░█▀▀░█▀█░█░░░█▀▀
        # ░▀░▀░▀▀▀░▀░▀░▀░▀░▀▀▀░▀░░░▀░▀░▀▀▀░▀▀▀
        # Switch workspaces with Control_Alt + [0-9]
        ...
        #       in
        #       [
        #         "$Control_Alt, ${ws}, workspace, ${toString (x + 1)}"
        #         "$Control_Alt_Super_L, ${ws}, movetoworkspace, ${toString (x + 1)}"
        #         "$Super_L_Shift, ${ws}, movetoworkspacesilent, ${toString (x + 1)}"
        #       ]
        #     ) 10
        #   ));
      };
