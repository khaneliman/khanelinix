    ...
    ''
      ...
      create_spaces() {
        ...
        if [[ $1 == "a" ]]; then
          ...
          set_wallpaper ${self.packages.${system}.wallpapers}/share/wallpapers/$(ls ${
            self.packages.${system}.wallpapers
      ...
      set_wallpapers() {
        if [[ $(command -v yabai) ]]; then
          LOCAL_WALLPAPERS="$(realpath ${self.packages.${system}.wallpapers}/share/wallpapers/)"
